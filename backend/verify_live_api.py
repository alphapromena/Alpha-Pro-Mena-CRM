...
users = [
    ("saleh@alphapromena.com",  "Sales123!", "Saleh",  334, 1019),
    ("amin@alphapromena.com",   "Sales123!", "Amin",   576, 1307),
    ("hasan@alphapromena.com",  "Sales123!", "Hasan",  548, 1174),
    ("ghaida@alphapromena.com", "Sales123!", "Ghaida", 337, 337),
]
...
admin_token = api_login("abdallah@alphapromena.com", "Manager123!")
for email, pwd, name, exp_active, exp_arch in users:
    token = api_login(email, pwd)
