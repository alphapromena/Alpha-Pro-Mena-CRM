...
def main():
    with httpx.Client(base_url=BASE_URL, timeout=15.0) as client:
        ...
        saleh_headers, saleh_data = login(client, "saleh@alphapromena.com", "<set-password>")
        ...
        abdullah_headers, abdullah_data = login(client, "abdallah@alphapromena.com", "<set-password>")
        ...
        aseel_headers, aseel_data = login(client, "aseel@alphapromena.com", "<set-password>")
