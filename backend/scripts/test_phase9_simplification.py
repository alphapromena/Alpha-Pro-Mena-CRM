...
async def run_all_tests():
    ...
    async with httpx.AsyncClient(transport=transport, base_url="http://test") as client:
        ...
        users_to_test = [
            ("saleh@alphapromena.com", "<set-password>", "Saleh", "USER"),
            ("amin@alphapromena.com", "<set-password>", "Amin", "USER"),
            ("hasan@alphapromena.com", "<set-password>", "Hasan", "USER"),
            ("ghaida@alphapromena.com", "<set-password>", "Ghaida", "USER"),
            ("abdallah@alphapromena.com", "<set-password>", "Abdullah", "MANAGER"),
            ("qusai@alphapromena.com", "<set-password>", "Qusai", "TEAM_LEAD"),
            ("aseel@alphapromena.com", "<set-password>", "Aseel", "DATA_OPS"),
        ]
