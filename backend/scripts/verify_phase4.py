...
ACCOUNTS = [
    ("saleh@alphapromena.com", "<set-password>", "USER"),
    ("hasan@alphapromena.com", "<set-password>", "USER"),
    ("amin@alphapromena.com", "<set-password>", "USER"),
    ("ghaida@alphapromena.com", "<set-password>", "USER"),
    ("qusai@alphapromena.com", "<set-password>", "TEAM_LEAD"),
    ("abdallah@alphapromena.com", "<set-password>", "MANAGER"),
]
