...
def login(email: str, password: str = "Sales123!"):
...
def test_live_api():
    ...
    # 1. Saleh (334 leads)
    token_saleh, user_saleh = login("saleh@alphapromena.com", "Sales123!")
    ...
    # 2. Amin (576 leads)
    token_amin, user_amin = login("amin@alphapromena.com", "Sales123!")
    ...
    # 3. Hasan (548 leads)
    token_hasan, user_hasan = login("hasan@alphapromena.com", "Sales123!")
    ...
    # 4. Ghaida (337 leads)
    token_ghaida, user_ghaida = login("ghaida@alphapromena.com", "Sales123!")
    ...
    # 5. Aseel (DATA_OPS)
    token_aseel, user_aseel = login("aseel@alphapromena.com", "Sales123!")
    ...
    # 6. Abdullah (MANAGER)
    token_mgr, user_mgr = login("abdallah@alphapromena.com", "Manager123!")
