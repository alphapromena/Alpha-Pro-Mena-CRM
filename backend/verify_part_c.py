...
def login(email, password="Sales123!"):
...
reps = [
    ("saleh@alphapromena.com",  "Sales123!", "Saleh"),
    ("amin@alphapromena.com",   "Sales123!", "Amin"),
    ("hasan@alphapromena.com",  "Sales123!", "Hasan"),
    ("ghaida@alphapromena.com", "Sales123!", "Ghaida"),
]
