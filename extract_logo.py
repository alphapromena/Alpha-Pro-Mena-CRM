...
doc = fitz.open('f:/New folder/Alpha MENA Branding Kit (1).pdf')
...
pix1.save('f:/New folder/frontend/public/logo-alpha-dark.png')

pix2 = p2.get_pixmap(dpi=300, clip=clip_full)
pix2.save('f:/New folder/frontend/public/logo-alpha-light.png')
...
pix_mark1.save('f:/New folder/frontend/public/logo-mark-dark.png')

pix_mark2 = p2.get_pixmap(dpi=300, clip=clip_mark)
pix_mark2.save('f:/New folder/frontend/public/logo-mark-light.png')

# Extract SVG paths
svg_text = p1.get_svg_image()
with open('f:/New folder/frontend/public/raw_page1.svg', 'w', encoding='utf-8') as f:
    f.write(svg_text)
